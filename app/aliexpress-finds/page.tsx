...
export const metadata: Metadata = {
  ...
  description: "Search AliExpress baby products through MishBaby and open attributed AliExpress product links.",
    ...
    <>
      <section className="relative isolate overflow-hidden bg-[#f1fbfe] px-5 py-14 sm:px-8 md:py-20">
        ...
        <div className="mx-auto max-w-6xl">
          <p className="text-sm font-extrabold uppercase tracking-[0.14em] text-[#009dcc]">AliExpress Finds</p>
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-[#063f5b]/70">
            Explore live AliExpress results for delivery to the United States without mixing them into MishBaby&apos;s carefully curated collection.
          </p>
        </div>
      </section>
