...
export function GoogleButton({ next = "/account" }: { next?: string }) {
  return (
    <form action={googleSignInAction}>
      ...
      <button className="flex w-full items-center justify-center gap-3 rounded-full border border-[#063f5b]/15 bg-white px-5 py-3 text-sm font-extrabold text-[#063f5b] transition hover:bg-[#f1fbfe]">
