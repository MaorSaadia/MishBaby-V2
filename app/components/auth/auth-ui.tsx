...
export function AuthShell({
  ...
  return (
    <section className="bg-[#f1fbfe] px-4 py-8 sm:px-8 sm:py-18">
      <div className="mx-auto max-w-md rounded-3xl border border-[#063f5b]/10 bg-white p-5 shadow-[0_24px_60px_-42px_rgba(6,63,91,.5)] sm:rounded-[2rem] sm:p-9">
        <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-[#009dcc]">
          {eyebrow}
        </p>
        <h1 className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-[#063f5b] sm:text-4xl">
          {title}
        </h1>
...
export function SubmitButton({
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="min-h-12 w-full rounded-full bg-[#009dcc] px-5 py-3 text-sm font-extrabold text-white transition hover:bg-[#0784b0] disabled:cursor-wait disabled:opacity-60"
    >
...
export const inputClass =
  "mt-2 min-h-12 w-full rounded-xl border border-[#063f5b]/15 bg-white px-4 py-3 text-base text-[#063f5b] placeholder:text-[#063f5b]/35";
